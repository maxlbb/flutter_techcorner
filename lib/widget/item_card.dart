...
import 'package:flutter_state_techcorner/provider/item_notifier.dart';
...
class ItemCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<ItemNotifier>(
      create: (ctx) => ItemNotifier(navigatorService: Provider.of<NavigatorService>(context, listen: false)),
